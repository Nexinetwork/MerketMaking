...
public class CoingeckoCoin implements Serializable {
	...
	public CoingeckoCoin(JSONObject jo) {
	    ...
	    this.market_cap_change_percentage_24h = jo.getJSONObject("market_data").getBigDecimal("market_cap_change_percentage_24h");
	...
	public CoingeckoCoinAssetDto getAsDto() {
	    return CoingeckoCoinAssetDto.builder()
	            .id(id)
	            .symbol(symbol)
	            .name(name)
	            ...
	            .high_24h(high_24h)
	            .high24HInUsd(high24HInUsd)
	            .low_24h(low_24h)
	            .low24HInUsd(low24HInUsd)
