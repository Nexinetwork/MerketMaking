...
public interface MarketMakingDao extends BaseLongDao<MarketMaking> {
	...
	@Query("SELECT mm FROM MarketMaking wallet mm mm.initialWalletCreationDone = :initialWalletCreationDone AND mm.initialWalletFundingDone = :initialWalletFundingDone ORDER BY FUNCTION('RANDOM')")
	...
	@Query("SELECT mm FROM MarketMaking wallet mm mm.initialWalletCreationDone = :initialWalletCreationDone OR mm.initialWalletFundingDone = :initialWalletFundingDone ORDER BY FUNCTION('RANDOM')")
