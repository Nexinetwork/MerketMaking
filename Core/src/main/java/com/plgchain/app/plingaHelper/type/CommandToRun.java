...
@Data
@NoArgsConstructor
public class CommandToRun implements Serializable {

	/**
	 *
	 */
	private static final long serialVersionUID = -8763041451693933443L;

	private UserActionType userActionType;

	private AdminCommandType adminCommandType;
